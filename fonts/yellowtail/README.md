...
import (
  ...
  _ "github.com/gmlewis/go-fonts-y/fonts/yellowtail"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from yellowtail"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "yellowtail", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
