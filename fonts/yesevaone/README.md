...
import (
  ...
  _ "github.com/gmlewis/go-fonts-y/fonts/yesevaone"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from yesevaone"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "yesevaone", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
